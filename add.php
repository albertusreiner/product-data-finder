...
<body>
    ...
    <div class="container result-table">
        ...
        <div id="reader"></div>
        <form method="post" id="productAdd" action="./db/addProduct.php">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" id="pnameAdd" name="pnameAdd" required>
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text">Details </span>
                <input type="textarea" class="form-control" id="pdetailsAdd" name="pdetailsAdd" required>
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text">Unit Price </span>
                <input type="number" class="form-control" id="ppriceAdd" name="ppriceAdd" required>
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text">Store Location </span>
                <input type="text" class="form-control" id="store_locAdd" name="store_locAdd" required>
            </div>
            <div class="input-group mb-3">
